...
#import "IShootJianBianSlider.h"

@interface IShootJianBianSlider()
...
@implementation IShootJianBianSlider {
...
//        _circle.layer.masksToBounds = YES;
        _circle.backgroundColor = RGB(60, 172, 132);
...
- (void)drawLayerAnimation {
    ...
    _layer1.colors = [NSArray arrayWithObjects:(id)[UIColor colorWithRed:166/255.0 green:0.0/255.0 blue:24.0/255.0 alpha:1.0].CGColor,(id)[UIColor colorWithRed:103/255.0 green:97.0/255.0 blue:93.0/255.0 alpha:1.0].CGColor, (id)[UIColor colorWithRed:60.0/255.0 green:172.0/255.0 blue:132.0/255.0 alpha:1.0].CGColor, nil];
    _layer1.frame = CGRectMake(0 * singleLength, 0 * singleLength, 0 * singleLength, 11 * singleLength);
    _layer1.locations = @[@0.0,@0.1,@1.0];
