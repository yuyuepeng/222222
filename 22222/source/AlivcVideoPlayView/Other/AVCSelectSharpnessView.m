...
- (UILabel *)downloadLabel{
    if (!_downloadLabel) {
        ...
        _downloadLabel.text = [@"—————— 视频下载 ——————" localString];
...
- (UIButton *)lookVideoButton{
    if (!_lookVideoButton) {
        ...
        [_lookVideoButton setTitle:[@"查看离线视频" localString] forState:UIControlStateNormal];
...
-(UILabel *)titleLabel{
    if (!_titleLabel) {
        ...
        _titleLabel.text = [@"视频标题" localString];
    }
    return _titleLabel;
}
...
- (UILabel *)selectInfoLabel{
    if (!_selectInfoLabel) {
        ...
        _selectInfoLabel.text = [@"选择清晰度" localString];
    }
...
+ (NSString *)stringWithQuality:(NSString *)quality{
    if ([quality isEqualToString:@"FD"]) {
        ...
        return [@"低音质" localString];
    }else if ([quality isEqualToString:@"HQ"]) {
        return [@"高音质" localString];
    }
