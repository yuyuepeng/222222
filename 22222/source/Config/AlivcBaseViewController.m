...
CGFloat PortraitmainWidth = 0;
CGFloat PortraitmainHeight = 0;
...
- (void)viewDidLoad {
    ...
    if(mainWidth > mainHeight){
        PortraitmainWidth = mainHeight;
        PortraitmainHeight = mainWidth;
    }else{
        PortraitmainWidth = mainWidth;
        PortraitmainHeight = mainHeight;
    }
