...
#define SizeHeight(H) (H *(mainHeight)/568)
...
// pushflow
#define AlivcmainWidth  [UIScreen mainScreen].bounds.size.width
#define AlivcmainHeight  [UIScreen mainScreen].bounds.size.height
#define AlivcSizeWidth(W) (W*(AlivcmainWidth)/320)
#define AlivcSizeHeight(H) (H*(AlivcmainHeight)/568)
...
//不同设备的屏幕比例
#define SizeScale ((AlivcmainHeight > 568) ? AlivcmainHeight/568 : 1)
//字幕模块文字大小根据屏幕分辨率适配
